...
# If we use a package WaveletComp, we can easily use a function to make the data with trend.
# The 'Ychange' data has changing periods, from 20 to 100, ends at x = 1000.
library(WaveletComp)
...
Day May27, 2021. Markdown trial Version 1 ends here.
